...
data class TenantInterceptionResponse(val data: List<InterceptionDetailResponse>)
data class InterceptionDetailResponse(val tenantId: TenantId, val sandboxKey: String, val redirectHost: String) {
